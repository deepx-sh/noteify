    ...
    <div className='max-w-4xl mx-auto p-6'>
      ...
      <div className='space-y-4 mb-6'>
        ...
        <div className='flex flex-wrap gap-2'>
          ...
          <button className='flex items-center gap-2 px-4 py-2 bg-gray-100 text-gray-700 hover:bg-gray-200 transition-colors duration-200 text-sm font-medium rounded-lg cursor-pointer'><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
