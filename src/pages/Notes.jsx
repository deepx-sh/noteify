    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {filterNotes.length > 0 &&
          ...
          }} className="px-3 py-1.5 bg-yellow-100 text-yellow-700 text-xs font-medium rounded-md cursor-pointer hover:bg-yellow-200 transition-colors duration-200 flex items-center gap-1.5"> <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
