              ...
              >
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  <button className="px-3 py-1.5 bg-blue-100 text-blue-700 text-xs font-medium rounded-md hover:bg-blue-200 transition-colors duration-200">
                    <Link to={`/notes/${note._id}`} className="flex items-center gap-1.5"> <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <button className="px-3 py-1.5 bg-purple-100 text-purple-700 text-xs font-medium rounded-md hover:bg-purple-200 transition-colors duration-200">
                    <Link to={`/?noteId=${note._id}`} className="flex items-center gap-1.5"><svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                  </svg> Edit</Link>
                  </button>

                  <button className="px-3 py-1.5 bg-red-100 text-red-700 text-xs font-medium rounded-md hover:bg-red-200 cursor-pointer transition-colors duration-200 flex items-center gap-1.5" onClick={() => handleDelete(note?._id)}>
                   <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                </svg>  Delete
                  </button>

                  <button className="px-3 py-1.5 bg-green-100 text-green-700 text-xs font-medium cursor-pointer rounded-md hover:bg-green-200 transition-colors duration-200 flex items-center gap-1.5"
                    onClick={() => {
                  ...
                  <button className="px-3 py-1.5 bg-yellow-100 text-yellow-700 text-xs font-medium rounded-md cursor-pointer hover:bg-yellow-200 transition-colors duration-200 flex items-center gap-1.5"> <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
